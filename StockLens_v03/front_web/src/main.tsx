...
type QRPayload = {
  app: "QR-Stock-v03" | "QR-Stock-v02" | "QR-Stock-v01";
  id: string;
};
...
const STORAGE_KEY = "stocklens-v03-state";
...
function parseQrValue(value: string): string | null {
  ...
  try {
    ...
    if (
      (parsed.app === "QR-Stock-v03" || parsed.app === "QR-Stock-v02" || parsed.app === "QR-Stock-v01") &&
...
function QrImage({ item }: { item: StockItem }) {
  ...
  const value = JSON.stringify({ app: "QR-Stock-v03", id: item.id });
