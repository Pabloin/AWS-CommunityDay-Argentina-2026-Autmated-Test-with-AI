...
resource "aws_resourcegroups_group" "stocklens_stack" {
  ...
  description = "StockLens v02 resources for AWS Community Day Argentina 2026"
...
resource "aws_resourcegroups_group" "by_owner" {
  ...
  description = "StockLens v02 resources grouped by owner"
...
resource "aws_resourcegroups_group" "by_event" {
  ...
  description = "StockLens v02 resources grouped by AWS Community Day Argentina event tag"
